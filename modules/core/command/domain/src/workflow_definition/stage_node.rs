...
use super::rule_in_context::RuleInContext;
use super::sensor_ref::SensorRef;
use super::stage_mode::StageMode;
use super::stage_number::StageNumber;
use super::stage_slug::StageSlug;

// ビルダーは `StageNode` の構造体リテラルを書く唯一の場所なので、本型のサブツリーに置く
// (子モジュールは親の private フィールドを見られる — 可視性を広げずに 1 ファイル 1 公開型に
// できる)。ここでの連鎖再輸出は所有サブツリーのファサードであり、利便再エクスポートでは
// ない (coding-rules/module-visibility.md)。
mod stage_node_builder;
...
mod tests {
    ...
    use super::super::brownfield_greenfield::BrownfieldGreenfield;
    use super::super::rule_scope::RuleScope;
    use super::super::unknown_brownfield_greenfield::UnknownBrownfieldGreenfield;
    use super::super::unknown_rule_scope::UnknownRuleScope;

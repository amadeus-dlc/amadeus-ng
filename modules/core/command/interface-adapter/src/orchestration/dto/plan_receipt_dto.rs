...
impl PlanReceiptDto {
    pub(super) fn of(value: &PlanApprovalReceipt) -> Self {
        Self {
            ...
            certified_source: value.certified_source().to_string(),
            status: match value.status() {
                PlanGenerationStatus::Approved => "approved",
                PlanGenerationStatus::Generation => "generation",
            }
            .to_string(),
        }
    }

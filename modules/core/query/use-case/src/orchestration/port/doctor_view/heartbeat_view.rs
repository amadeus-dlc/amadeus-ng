...
use super::{HeartbeatEntryView, TimestampView};
...
pub struct HeartbeatView {
    ...
    entries: Vec<HeartbeatEntryView>,
    progressed_stage_count: usize,
    stage_started: bool,
    newest_progress: Option<TimestampView>,
}
...
impl HeartbeatView {
    ...
    #[must_use]
    pub fn entries(&self) -> &[HeartbeatEntryView] {
        &self.entries
    }
    ...
    #[must_use]
    pub const fn newest_progress(&self) -> Option<&TimestampView> {

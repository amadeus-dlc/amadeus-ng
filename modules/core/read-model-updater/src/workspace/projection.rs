...
use core_command_domain::workspace::{
    AuditFieldKey, AuditFields, CheckboxState, Checkboxes, PromotedSection, append_under_heading,
    ensure_heading, replace_section,
};
...
mod tests {
    ...
    use core_command_domain::workspace::{CheckboxUpdateError, PromotedSections, RuleLines};

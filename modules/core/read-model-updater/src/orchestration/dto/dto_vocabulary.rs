...
/// ステージの実行区分の綴り (ジャーナル面)。
pub(crate) const fn execution_kind_spelling(value: ExecutionKind) -> &'static str {
    match value {
...
/// ステージの実行区分の復号 (ジャーナル面)。
pub(crate) fn execution_kind_of(raw: &str) -> Result<ExecutionKind, DtoDecodeError> {
    match raw {
...
/// ステージの実行様式の綴り (ジャーナル面)。
pub(crate) const fn stage_mode_spelling(value: StageMode) -> &'static str {
    match value {
...
/// ステージの実行様式の復号 (ジャーナル面)。
pub(crate) fn stage_mode_of(raw: &str) -> Result<StageMode, DtoDecodeError> {
    match raw {
...
/// レビュー重量の綴り (ジャーナル面)。
pub(crate) const fn review_class_spelling(value: ReviewClass) -> &'static str {
    match value {
...
/// レビュー重量の復号 (ジャーナル面)。
pub(crate) fn review_class_of(raw: &str) -> Result<ReviewClass, DtoDecodeError> {
    match raw {
...
/// 規則の出自の綴り (ジャーナル面)。
pub(crate) const fn rule_scope_spelling(value: RuleScope) -> &'static str {
    match value {
        RuleScope::Org => "Org",
        RuleScope::Team => "Team",
...
/// 規則の出自の復号 (ジャーナル面)。
pub(crate) fn rule_scope_of(raw: &str) -> Result<RuleScope, DtoDecodeError> {
    match raw {
...
pub(crate) const fn skeleton_default_spelling(value: SkeletonDefault) -> &'static str {
    match value {
...
pub(crate) fn skeleton_default_of(raw: &str) -> Result<SkeletonDefault, DtoDecodeError> {
    match raw {
...
pub(crate) const fn review_cap_spelling(value: ReviewCapValue) -> &'static str {
    match value {
...
/// レビュー上限の復号 (ジャーナル面)。
pub(crate) fn review_cap_of(raw: &str) -> Result<ReviewCapValue, DtoDecodeError> {
    match raw {

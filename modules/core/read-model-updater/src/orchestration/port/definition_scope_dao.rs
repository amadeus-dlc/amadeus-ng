//! `read_definition_scope` 表の DAO — この表 1 つの I/O だけを持つ。

use rusqlite::{Connection, Transaction};

use super::{DefinitionScopeRow, TableContent};
use crate::orchestration::{GlobalSeqNr, JournalReadError};

/// `read_definition_scope` 表 (定義のスコープ 1 つ) の DAO。
///

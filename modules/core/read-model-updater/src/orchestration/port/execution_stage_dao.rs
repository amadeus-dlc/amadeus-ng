//! `read_execution_stage` 表の DAO — この表 1 つの I/O だけを持つ。

use rusqlite::{Connection, Transaction};

use super::{ExecutionStageRow, TableContent};
use crate::orchestration::{GlobalSeqNr, JournalReadError};

/// `read_execution_stage` 表 (実行のステージ 1 つ) の DAO。
///

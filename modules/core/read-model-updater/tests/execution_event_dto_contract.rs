...
use core_command_domain::orchestration::{
    ActiveDirective, AnswerDisposition, AnswerId, AnswerRecorded, ArtifactPaths,
    ArtifactReuseReceipt, ArtifactReused, AutonomyMode, AutonomyModeSet, CapturedLearning,
    CapturedLearnings, CodeGenerationAuthority, CommandFailed, CommandFailure, DecisionPrompt,
    DecisionRecorded, DirectiveContextInvalidated, DirectiveIssued, DirectivePublication,
    EmptyMemoryStages, GateApproved, GateOpened, GateRejected, HealthCheckResult, HealthChecked,
    IntentExecutionEvent, IntentExecutionEventId, JumpArtifact, JumpDirection, JumpObservation,
    JumpScope, Jumped, Learning, LearningCandidateId, LearningDisposition, LearningProvenance,
    LearningScope, LearningSource, LearningsCaptured, MemoryJournal, MemoryJournalSurvey,
    MemoryJournalsObserved, Parked, PipelineHandoff, PipelineLinkCompleted, PipelineReceipt,
    ...
    PracticesAffirmed, PromptObserved, PublishedDirective, Recomposed, ReportId, ReportNoOp,
    ReportResult, ReportTransition, Reported, ReviewCompleted, ReviewRequested, ReviewVerdict,

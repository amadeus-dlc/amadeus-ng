...
graph TD
    ...
    U8 --> U7
```
<!-- Text fallback: 矢印は「依存元 → 依存先」。U3→U2。U4→U2,U3。U5→U2,U3,U4。U6→U1,U2,U3。U7→U1,U4,U5,U6。U8→U7。U1・U2・U9・U10 は依存なし（根）。循環なし。 -->
...
| U5 → U4 | コマンド末尾の投影キャッチアップ起動（report の出力契約に監査行が含まれる） |
